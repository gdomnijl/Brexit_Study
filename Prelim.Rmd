...
#Step One:
## Collect general stay/leave percent from each wave
...
opinion_p %>% 
  ...
  scale_shape_discrete(name="Votes",
                        breaks=c("leave_p", "stay_p"),
                        labels=c("Leave the EU", "Stay/remain in the EU")) + ggtitle("General Opinion of BrExit Across Waves")
```



#Step Two: Look at demographic subgroups 
## Step 2.1: create new dataset
...
## For An
write.csv(dat_origin, "An_dataset.csv")
